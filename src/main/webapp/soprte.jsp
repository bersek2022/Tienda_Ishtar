    <style>html{margin-top:0 !important;}</style>
      ...
      <main class="main bg-dark">
        <iframe class="iframe-preview" width="100%" src="https://htmlstream.com/preview/space-v2.3.1/"></iframe>
    </main>
    ...
    <nav class="navbar navbar-preview fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center w-100"><a class="my-lg-0 text-gray-soft" href="https://themes.getbootstrap.com/product/space-multipurpose-responsive-template/"><i class="bootstrap-themes-icon-left-open-1"></i> View theme <span class="d-none d-sm-inline">info</span></a>
            ...
            <div class="form-inline">
                ...
                <a class="text-gray ml-3" href="https://htmlstream.com/preview/space-v2.3.1/">
                  <small>
