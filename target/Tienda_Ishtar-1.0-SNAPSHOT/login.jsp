...
<html lang="en">
    ...
    <body class="text-center">
        ...
        <main class="form-signin">
              <h1>ISHTAR BOLIVIA</h1>
            <form action="loginController" method="post">
                <img class="mb-4" src="img/1.png" alt="" width="150" height="150">
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit">INGRESAR</button>
                 ...
                 <p class="mt-5 mb-3 text-muted"> para ingresar por primera vez</p>
                  <p class="mt-5 mb-3 text-muted">correo:principal@gmail</p>
                   <p class="mt-5 mb-3 text-muted"> passsword:admin</p>
            </form>
        </main>
